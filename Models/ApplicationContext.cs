...
namespace Feedbacks.Models
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            User bob = new User { Id = 1, CityId = 1, Email = "bob@gmail.com", Password = "12345", RoleId = adminRole.Id };
            User tom = new User { Id = 2, CityId = 1, Email = "tom@gmail.com", Password = "12345", RoleId = adminRole.Id };
            User sam = new User { Id = 3, CityId = 2, Email = "sam@gmail.com", Password = "12345", RoleId = userRole.Id };
